<template>
  ...
  <!-- <div> -->
    ...
    <!-- <cell
      ...
      @animation-finish="resetCell(index)"
    />
  </div> -->
</template>
...
//     if(rr.length + 1 >= 3)
//       res = res.concat(rr, [[row, col]])
//     if(cc.length + 1 >= 3)
//       res = res.concat(cc, [[row, col]])
//   }
...
//   console.log(cellsToCheck.value)
...
//       if(boardState.value[i][lowest[1]].color === CellColor.EMPTY)
//         cellsToMove.value.push([i, lowest[1]])
//   }
// }, 500))
...
//     } else {
//       if(boardState.value[row-1][col].color === CellColor.EMPTY) {
//         updatedCells.push([row, col])
//       } else {
//         swapCells([row, col], [row-1, col])
//         updatedCells.push([row-1, col])
//         if(row+1 == boardHeight.value || boardState.value[row+1][col].color !== CellColor.EMPTY)
//           cellsToCheck.value.push([row, col])
//       }
//     }
//   }
